...
public class TaskCheckout {
    ...
    public TaskCheckout(WebDriver driver) {
        Cdriver = driver;
...
//        Assert.assertEquals(firstElement, "TheTest.allTheThings() T-Shirt (Red)");
//        Thread.sleep(2000);
...
//        Thread.sleep(2000);
//        driver.findElement(By.xpath("//button[@id='TaskCheckout']")).click();
//        Thread.sleep(2000);
